                        ...
                        <div class="card card-body">
                            ...
                            <div class="text-center">
                                <ul class="list-inline chart-detail-list mb-0">
                                    ...
                                    <li class="list-inline-item">
                                        <h6 class="text-success"><i class="mdi mdi-triangle-outline me-1"></i>Series B
                                        </h6>
                                    </li>
                                    <li class="list-inline-item">
                        ...
                        <div class="card card-body">
                            ...
                            <div class="text-center">
                                <ul class="list-inline chart-detail-list mb-0 mt-2">
                                    ...
                                    <li class="list-inline-item">
                                        <h6 class="text-success"><i class="mdi mdi-triangle-outline me-1"></i>Italian
                                        </h6>
                                    </li>
                                    <li class="list-inline-item">
                        ...
                        <div class="row">
                                        ...
                                        <a href="#">
                                            <div class="d-flex align-items-center gap-2 py-2">
                                                ...
                                                <div class="me-auto">
                                                    ...
                                                    <p class="text-muted mb-0 text-truncate">I've finished it! See you
                                                        so...</p>
                                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="card card-body">
                                    ...
                                    <p class="font-weight-semibold mb-3">iMacs <span
                                            class="text-danger float-end"><b>78%</b></span></p>
                ...
                <div class="page-container">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <script>document.write(new Date().getFullYear())</script> © Uplon - By <span
